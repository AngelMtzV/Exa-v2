            ...
            <form method="POST" action="{{ route('usuarios.update',Crypt::encrypt($usuario->id)) }}">
              ...
              <div class="form-row">
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" placeholder="Nombre" value="{{ $usuario->name }}" required>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control{{ $errors->has('apellidos') ? ' is-invalid' : '' }}" id="apellidos" name="apellidos" placeholder="Apellidos" value="{{ $usuario->apellidos }}" required>
                    <div class="valid-feedback">
                  ...
                  <div class="col-md-4 mb-3">
                    <label for="usuario">{{ __('Usuario') }}</label>
                      <input type="text" class="form-control{{ $errors->has('usuario') ? ' is-invalid' : '' }}" id="usuario" name="usuario" placeholder="Nombre de usuario" aria-describedby="inputGroupPrepend" value="{{ $usuario->usuario }}" required>
              ...
              <div class="form-row">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Ejemplo@gmail.com" value="{{ $usuario->email }}" required>
                ...
                <div class="form-group col-md-8">
                      ...
                      <label for="password">Si desea modificar la contraseña <a href="">clic aquí</a></label>
                </div>
              </div>
              <div class="form-row">
              ...
              <div class="form row">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <select id="profesion" name="profesion" class="form-control">
                          <option selected>{{ $usuario->profesion }}</option>
